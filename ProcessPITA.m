...
function ProcessPITA
    global window_size Fs PathName num_sensors%filt_selected
    % close all
...
function slider_moved(hObject, ~, data)
    global window_size Fs num_sensors%filt_selected
    time_slider = hObject;
    %obtain spectrum
    N = window_size;
