...
global OUTPUT PathName
    ...
    %save DATA 
    tbl = array2table([OUTPUT.Data.TimeDomain.Time ...
		OUTPUT.Data.TimeDomain.Acceleration]);
    ...
    tbl = array2table([OUTPUT.Data.FreqDomain.Frequency ...
		OUTPUT.Data.FreqDomain.Acceleration]);
    ...
    writetable(OUTPUT.Tables.TestConfig, [base_file '.xlsx'], ...
        'Sheet', 'Configuration', 'Range', 'A1');
    writetable(OUTPUT.Tables.SensorConfig, [base_file '.xlsx'], ...
    ...
    writetable(tbl, [base_file '.xlsx'], 'Sheet', 'Configuration', ...
		'Range', 'A15');
...
function zoom_button_callback(hObject, ~)
    ...
    function prezoomCB(~, eventData)
        disp('PRE');
        disp(eventData.Axes.YLim)
    end
    function postzoomCB(~, eventData)
        disp('POST');
        disp(eventData.Axes.YLim)
    end
end
